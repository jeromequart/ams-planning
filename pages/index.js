...
export default function Home() {
  ...
  const loaded = loadedS && loadedM && loadedMT;
      ...
      <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
        ...
        <main style={{ maxWidth: 1200, margin: '0 auto', padding: '28px 24px' }}>
          {!loaded ? (
            ...
            <PlanningView salaries={salaries} missions={missions} missionTypes={missionTypes} />
          ) : mode === 'admin' ? (
            <AdminView salaries={salaries} setSalaries={setSalaries} missions={missions} setMissions={setMissions} missionTypes={missionTypes} />
          ) : mode === 'missions' ? (
            ...
            <EmployeeView salaries={salaries} missions={missions} missionTypes={missionTypes} />
          )}
        </main>
